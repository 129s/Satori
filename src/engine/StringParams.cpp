    ...
    static const std::vector<ParamInfo> kParams = [] {
        ...
        return std::vector<ParamInfo>{
            ...
            {ParamId::DispersionAmount, "dispersionAmount", ParamType::Float, 0.0f, 1.0f,
             0.12f},
            {ParamId::WaveEnabled, "waveEnabled", ParamType::Bool, 0.0f, 1.0f, 1.0f},
            {ParamId::WaveLevel, "waveLevel", ParamType::Float, 0.0f, 1.0f, 0.0f},
            {ParamId::WaveformType, "waveformType", ParamType::Enum, 0.0f, 4.0f, 0.0f},
            {ParamId::WaveDuty, "waveDuty", ParamType::Float, 0.01f, 0.99f, 0.5f},
            {ParamId::NoiseEnabled, "noiseEnabled", ParamType::Bool, 0.0f, 1.0f, 1.0f},
            {ParamId::NoiseLevel, "noiseLevel", ParamType::Float, 0.0f, 1.0f, 1.0f},
            {ParamId::NoiseJitter, "noiseJitter", ParamType::Float, 0.0f, 1.0f, 1.0f},
            {ParamId::NoiseOverdrive, "noiseOverdrive", ParamType::Float, 0.0f, 1.0f, 0.0f},
            {ParamId::NoiseColor, "noiseColor", ParamType::Float, 0.0f, 1.0f, 1.0f},
